          ...
          <div className='space-y-8 max-w-[50vw]'>
            ...
            <code>
              <span style={{ color: "#CE9178" }}>
                <a href="https://github.com/Eman-Tedias/Portfolio" target="_blank" rel="noopener noreferrer" style={{ color: "#569CD6", textDecoration: "underline" }}>
...
export default EstePortfolioContent;